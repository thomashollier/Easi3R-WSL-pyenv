...
def get_args_parser():
    ...
    # model and criterion
    parser.add_argument('--model', default="AsymmetricCroCo3DStereo(pos_embed='RoPE100', patch_embed_cls='PatchEmbedDust3R', \
                        ...
                        # TODO: patch_embed_cls='ManyAR_PatchEmbed' or 'PatchEmbedDust3R' landscape_only=False or True
    ...
    parser.add_argument('--temporal_smoothing_weight', default=0.0, type=float, help='temporal smoothing weight for pose optimization')
